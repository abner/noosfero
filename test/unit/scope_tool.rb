...
class ScopeToolTest < ActiveSupport::TestCase
  ...
  should 'filter united scopes' do
    cmm1 = create Community, :visible => true
    cmm2 = create Community, :visible => false
    ent1 = create Enterprise, :visible => true
    ent2 = create Enterprise, :visible => false
    orgs = union(Profile.communities, Profile.enterprises)
